...
-- OAuth应用管理
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('160000001', '2', 'OAuth应用管理', 2, 7, NULL, '/sub-security/oauth-client', 1, 1, '(main)POST:security:/oauth/client/page;(main)GET:security:/oauth/client/enums', NULL, 'admin', '2026-09-04 15:45:00', 'admin', '2026-09-04 15:45:00', 0, NULL, NULL, 1, 1, NULL, '维护允许接入OAuth2认证的客户端应用，配置授权模式、回调地址、Scope、PKCE和授权确认策略。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('160000002', '160000001', '新增OAuth应用', 3, 0, NULL, NULL, 1, 1, '(main)POST:security:/oauth/client', NULL, 'admin', '2026-09-04 15:45:00', 'admin', '2026-09-04 15:45:00', 0, NULL, NULL, 1, 1, 'oauth_client_add', '新增OAuth客户端应用配置。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('160000003', '160000001', '编辑OAuth应用', 3, 0, NULL, NULL, 1, 1, 'GET:security:/oauth/client/id/{id};(main)POST:security:/oauth/client', NULL, 'admin', '2026-09-04 15:45:00', 'admin', '2026-09-04 15:45:00', 0, NULL, NULL, 1, 1, 'oauth_client_edit', '编辑OAuth客户端应用配置。');
