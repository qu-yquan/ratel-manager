...
-- 角色初始化
INSERT INTO security_role (id, role_name, role_code, sort, description, status, role_type, data_scope, tenant_id,
                           create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('1', '超级管理员', 'super_admin', 1, '拥有所有权限', 1, 1, 1, NULL, NULL, '2026-05-02 01:52:45.688324', 'admin',
        '2026-05-04 15:44:28.18939', 0, NULL, NULL);
INSERT INTO security_role (id, role_name, role_code, sort, description, status, role_type, data_scope, tenant_id,
                           create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2', '通用角色', 'common', 1, '所有用户都拥有该角色', 1, 1, 4, NULL, NULL, '2026-05-02 01:52:45.688324',
        'admin', '2026-05-26 10:24:21.803287', 0, NULL, NULL);

-- 权限初始化
INSERT INTO security_abac (id, tenant_id, expression, description, status, create_op, create_time, modify_op,
                           modify_time, delete_op, delete_time, deleted)
VALUES ('1', 'default', 'contains(r.sub.roles , ''super_admin'')', '超级管理员角色表达式', 1, NULL,
        '2026-04-04 06:30:06.683643', NULL, '2026-04-04 06:30:06.683643', NULL, NULL, 0);
INSERT INTO security_abac (id, tenant_id, expression, description, status, create_op, create_time, modify_op,
                           modify_time, delete_op, delete_time, deleted)
VALUES ('2059099745615486976', 'default', 'contains(r.sub.roles , ''common'')', NULL, 1, 'admin',
        '2026-05-26 10:30:10.235452', 'admin', '2026-05-26 10:30:10.235452', NULL, NULL, 0);

INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status,
                                      create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted)
VALUES ('1', 'default', '1', '*', '*', '*', 'allow', 1, NULL, '2026-05-02 11:17:56.593787', NULL,
        '2026-05-02 11:17:56.593787', NULL, NULL, 0);
INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status,
                                      create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted)
VALUES ('2074860014971060225', 'default', '2059099745615486976', 'system', 'PUT', '/manager/password', 'allow', 1,
        'admin', '2026-07-08 22:15:51.269159', 'admin', '2026-07-08 22:15:51.269159', NULL, NULL, 0);
INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status,
                                      create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted)
VALUES ('2074860014979448833', 'default', '2059099745615486976', 'system', 'PUT', '/manager/profile', 'allow', 1,
        'admin', '2026-07-08 22:15:51.26977', 'admin', '2026-07-08 22:15:51.26977', NULL, NULL, 0);
INSERT INTO security_abac_permission (id, tenant_id, abac_id, resource_type, action, url_pattern, effect, status,
                                      create_op, create_time, modify_op, modify_time, delete_op, delete_time, deleted)
VALUES ('2074860014992031745', 'default', '2059099745615486976', 'security', 'GET', '/role/rolesByCurrUser', 'allow', 1,
        'admin', '2026-07-08 22:15:51.270041', 'admin', '2026-07-08 22:15:51.270041', NULL, NULL, 0);

-- 角色用户关联初始化
INSERT INTO security_role_subject (id, subject_id, role_id, tenant_id, create_op, create_time, modify_op, modify_time,
                                   deleted, delete_op, delete_time)
VALUES ('1', '1', '1', NULL, NULL, '2026-05-01 01:16:11.414947', NULL, NULL, 0, NULL, NULL);

-- 数据权限
INSERT INTO security_data_resource (id, schema_name, table_name, description, support_self_only, self_only_field,
                                    status, tenant_id, create_op, create_time, modify_op, modify_time, deleted,
                                    delete_op, delete_time, catalog_name)
VALUES ('2076622640277331968', 'public', 'sys_user_dept', NULL, 0, NULL, 1, NULL, 'admin', '2026-07-13 18:59:53.882136',
        'kaifa', '2026-07-13 19:54:43.440546', 0, NULL, NULL, 'gwsu');
INSERT INTO security_data_resource_condition (id, data_resource_id, field_name, show_null, user_resource_fields,
                                              assert_type, relationship, sort, tenant_id, create_op, create_time,
                                              modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2076622640365412352', '2076622640277331968', 'dept_id', 1, 'deptId', 'EQ', 'AND', 1, NULL, 'kaifa',
        '2026-07-13 19:54:43.452626', 'kaifa', '2026-07-13 19:54:43.452626', 0, NULL, NULL);

-- 系统配置初始化
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2061834119926693888', 'assistant_view_config', '助手展示配置',
        '{"showThinking":true,"showToolCalls":true,"showHistory":true,"enableDragMode":true}', 4, 1,
        'AI 助手界面展示配置', NULL, 'admin', '2026-06-02 23:35:35.874567', 'admin', '2026-06-02 23:51:24.23065', 0,
        NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2060910412299448320', 'model_llm_config', '助手配置',
        '{"provider":"openai","dashscope":{"apiKey":"","modelName":"qwen-plus","stream":true,"enableThinking":false,"enableSearch":false,"baseUrl":""},"openai":{"apiKey":"","modelName":"deepseek-v4-flash","stream":true,"baseUrl":"https://api.deepseek.com","endpointPath":"/chat/completions"},"gemini":{"apiKey":"","modelName":"gemini-2.0-flash","stream":true,"project":"","location":"us-central1"},"anthropic":{"apiKey":"","modelName":"claude-sonnet-4-5-20250929","stream":true,"baseUrl":""},"generateOptions":{"temperature":0.2,"topP":0.75,"frequencyPenalty":0.5,"presencePenalty":0.5,"additionalBodyParams":{"thinking":{"type":"enabled"},"reasoning":{"effort":"medium"}}}}',
        4, 1, 'AI 助手模型提供商及生成参数配置', NULL, 'admin', '2026-05-31 10:25:06.816008', 'admin',
        '2026-06-02 23:11:03.469723', 0, NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
...
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2060910012284210100', 'upload_file_extension_config', '文件后缀过滤配置',
        '{"enabled":false,"disable":"gz,exe,sh"}', 4, 1, '禁止上传的文件后缀配置', NULL, 'admin',
        '2026-06-07 10:29:14.684068', 'admin', '2026-06-07 18:58:39.410433', 0, NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2060910412284210129', 'upload_server_info_config', '上传服务配置',
        '{"type":"LOCAL","group":null,"local":{"path":""},"minio":{"url":"","accessKey":"","secretKey":""},"oss":{"endpoint":"","accessKey":"","secretKey":""},"cos":{"endpoint":"","accessKey":"","secretKey":"","region":""},"extension":{"disable":null,"enabled":false}}',
        4, 1, '文件上传服务类型及连接配置', NULL, 'admin', '2026-06-06 01:47:27.244244', 'admin',
        '2026-06-07 22:40:29.116529', 0, NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2068877431517908992', 'assistant_remote_control_config', '助手远程控制配置',
        '{"dingTalk":{"aiCardTemplateId":"7f991cfb-9c52-4bac-aad2-5c60116d82cc.schema","clientId":null,"clientSecret":null,"endpoint":"api.dingtalk.com","protocol":"https","regionId":"central"},"type":null}',
        4, 1, 'AI助手远程控制(钉钉)配置', NULL, NULL, '2026-06-22 02:05:07.109859', NULL, NULL, 0, NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2069619545202655232', 'basic_url_config', '基础地址配置',
        '{"viewBaseUrl":"http://127.0.0.1","apiBaseUrl":"http://127.0.0.1/api"}', 4, 1, '项目前后端基础地址配置', NULL,
        'admin', '2026-06-24 11:12:05.905821', 'admin', '2026-06-30 16:15:41.655821', 0, NULL, NULL);
INSERT INTO security_config (id, config_key, config_name, config_value, value_type, config_type, description, tenant_id,
                             create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time)
VALUES ('2060910412291281761', 'captcha_config', '验证码配置',
...
-- 公共角色"个人中心"绑定
INSERT INTO security_role_menu (id, role_id, menu_id, valid_type, valid_start, valid_end, cycle_type, cycle_value,
                                cycle_start_time, cycle_end_time, tenant_id, create_op, create_time, modify_op,
                                modify_time, deleted, delete_op, delete_time)
VALUES ('2074860014971060224', '2', '100292273', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin',
        '2026-07-08 22:15:51.261576', 'admin', '2026-07-08 22:15:51.261576', 0, NULL, NULL);
INSERT INTO security_role_menu (id, role_id, menu_id, valid_type, valid_start, valid_end, cycle_type, cycle_value,
                                cycle_start_time, cycle_end_time, tenant_id, create_op, create_time, modify_op,
                                modify_time, deleted, delete_op, delete_time)
VALUES ('2074860014979448832', '2', '100292272', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin',
        '2026-07-08 22:15:51.264192', 'admin', '2026-07-08 22:15:51.264192', 0, NULL, NULL);
INSERT INTO security_role_menu (id, role_id, menu_id, valid_type, valid_start, valid_end, cycle_type, cycle_value,
                                cycle_start_time, cycle_end_time, tenant_id, create_op, create_time, modify_op,
                                modify_time, deleted, delete_op, delete_time)
VALUES ('2074860014992031744', '2', '99868209', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin',
        '2026-07-08 22:15:51.266312', 'admin', '2026-07-08 22:15:51.266312', 0, NULL, NULL);
-- 公共角色"API_KEY"绑定
INSERT INTO security_role_menu (id, role_id, menu_id, valid_type, valid_start, valid_end, cycle_type, cycle_value,
                                cycle_start_time, cycle_end_time, tenant_id, create_op, create_time, modify_op,
                                modify_time, deleted, delete_op, delete_time)
VALUES ('2076874974039367680', '2', '134159585', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin',
        '2026-07-14 11:42:34.939892', 'admin', '2026-07-14 11:42:34.939892', 0, NULL, NULL);


INSERT INTO security_role_menu_permission (id, role_menu_id, abac_permission_id, tenant_id, create_op, create_time,
                                           modify_op, modify_time, deleted, delete_op, delete_time, api_id)
VALUES ('2074860015017197568', '2074860014971060224', '2074860014971060225', NULL, 'admin',
        '2026-07-08 22:15:51.272835', 'admin', '2026-07-08 22:15:51.272835', 0, NULL, NULL,
        'ccc85e9422ba9c46ae1ef7199922e6c5');
INSERT INTO security_role_menu_permission (id, role_menu_id, abac_permission_id, tenant_id, create_op, create_time,
                                           modify_op, modify_time, deleted, delete_op, delete_time, api_id)
VALUES ('2074860015021391872', '2074860014979448832', '2074860014979448833', NULL, 'admin',
        '2026-07-08 22:15:51.273461', 'admin', '2026-07-08 22:15:51.273461', 0, NULL, NULL,
        'ad359b600ca96121355b9a64df8750f1');
INSERT INTO security_role_menu_permission (id, role_menu_id, abac_permission_id, tenant_id, create_op, create_time,
                                           modify_op, modify_time, deleted, delete_op, delete_time, api_id)
