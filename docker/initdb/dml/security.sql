...
启用和停用指定任务');
-- 知识文档管理
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('138666105', '2', '知识文档管理', 2, 6, NULL, '/sub-security/knowledge', 1, 1, '(main)GET:kit:/knowledge/directory/tree;GET:kit:/knowledge/node/children;GET:kit:/knowledge/node/search;POST:kit:/knowledge/document/{documentId};GET:kit:/knowledge/document/{documentId}/markdown;GET:kit:/knowledge/document/{documentId}/events;POST:kit:/knowledge/search;POST:kit:/knowledge/chunk/adjacent', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, NULL, '左侧目录树，右侧目录与文档列表。未授权内容默认不可见。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('138666393', '138666105', '上传/重新导入/编辑文档', 3, 0, NULL, NULL, 1, 1, '(main)POST:kit:/knowledge/document/save;POST:kit:/knowledge/task/retry/{taskId};POST:kit:/knowledge/document/markdown', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '138666105_knowledge_upload', '上传、重新导入文档及编辑Markdown。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('143293897', '138666105', '启/禁用文档', 3, 0, NULL, NULL, 1, 1, '(main)POST:kit:/knowledge/document/enable/{documentId};POST:kit:/knowledge/document/disable/{documentId}', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '138666105_knowledge_disabled_enable', '启用或禁用文档。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('143294233', '138666105', '删除目录和文档', 3, 0, NULL, NULL, 1, 1, '(main)POST:kit:/knowledge/node/delete', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '138666105_knowledge_remove', '批量删除目录和文档，删除目录时同时删除下级内容。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('180000101', '138666105', '目录管理', 3, 0, NULL, NULL, 1, 1, '(main)POST:kit:/knowledge/directory/save', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '138666105_knowledge_directory_edit', '新建和重命名知识目录。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('180000103', '138666105', '检索调试', 3, 0, NULL, NULL, 1, 1, '(main)POST:kit:/knowledge/search/debug;POST:kit:/knowledge/search/debug/adjacent;GET:kit:/knowledge/directory/manage/tree;GET:security:/role/list', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '138666105_knowledge_search_debug', '按目录或角色测试知识检索。');
INSERT INTO security_menu (id, parent_id, menu_name, menu_type, sort, icon, path, visible, status, permission, tenant_id, create_op, create_time, modify_op, modify_time, deleted, delete_op, delete_time, position, owner, button_key, description) VALUES ('180000104', '5', '知识目录权限', 3, 0, NULL, NULL, 1, 1, '(main)GET:kit:/knowledge/directory/manage/tree;GET:kit:/knowledge/role/{roleCode}/directories;POST:kit:/knowledge/role/directories', NULL, 'admin', '2026-09-20 00:00:00', 'admin', '2026-09-20 00:00:00', 0, NULL, NULL, 1, 1, '5_knowledge_directory_permission', '在角色管理中分配知识目录权限。');
